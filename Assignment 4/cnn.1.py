#Here we try using a single convolutional layer, with a 3x3 pattern and 64 outputs
...
with tf.name_scope("Weights"):
    w = init_weights([3, 3, 3, 64])       # 3x3x3 conv, 64 outputs
    w_fc = init_weights([64 * 16 * 16, 625]) # FC 64 * 14 * 14 inputs, 625 outputs
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter('./board/question1part5/model2', sess.graph)
